...
export class JobCardService {
  ...
  sttsOpen: string;
  sttsClose: string;
  XIS_JOBS9Collection$: any;
  XIS_JOBS11Collection$: any;
  ...
  constructor(private store: Store<any>, private http: Http) {
    store
      ...
      .subscribe(
        (state: any) => {
          this.XIS_JOBS9Collection$ = state.collections.XIS_JOBS9;
          this.XIS_JOBS11Collection$ = state.collections.XIS_JOBS11;
        }
      )
  }
